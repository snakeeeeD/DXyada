...
float Sound::GetDefaultVolume(SOUND_LABEL label)
{
	switch (label)
	{
	...
	case	SOUND_LABEL_SE_Aim:				//エイムアシストが出た時
	case	SOUND_LABEL_SE_Throw:			//リボンを投げる
	case	SOUND_LABEL_SE_Assist:			//エイムアシストがヒットした時
	case	SOUND_LABEL_SE_Decorate:		//飾った時
	case	SOUND_LABEL_SE_Kiran:			//ジャストで飾った時
	case	SOUND_LABEL_SE_Damage:			//被ダメ時
	case	SOUND_LABEL_SE_Fall:			//落下死した時
	case	SOUND_LABEL_SE_RibbonJump:		//ピンで大ジャンプをした時
	case	SOUND_LABEL_SE_Pull:			//ブロックを動かした時
	case	SOUND_LABEL_SE_Ok:				//決定
	case	SOUND_LABEL_SE_Pause:			//ポーズ画面を開いた時
	case	SOUND_LABEL_SE_Select:			//カーソルを動かした時
	case	SOUND_LABEL_SE_Back:			//キャンセルの音
	case	SOUND_LABEL_SE_Hariyamasan:		//針を投げる時
	case	SOUND_LABEL_SE_Ribbon_hodoki:	//リボンをほどく時
		return 0.2f;
...
void Sound::Play(SOUND_LABEL label)
{
	...
	pSV->SetVolume(GetDefaultVolume(label));
	pSV->Start(0);
}
//=============================================================================
// 停止
